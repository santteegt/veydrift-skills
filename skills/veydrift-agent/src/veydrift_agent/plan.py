...
5-9. a three-band candidate pipeline (see below) -- deadline-driven storage overflow,
     then economically-scored building, then policy-declared research/ships/defense,
     else an explicit NO-OP.
```
...
1. Calls the three `select_*` functions in the three-band precedence order below.
...
**Three bands, in order** (docs/SPEC.md §5.4):
