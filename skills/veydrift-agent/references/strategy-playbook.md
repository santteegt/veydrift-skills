...
for that mine (30 / 20 / 10 per scaled level — [VeydriftFormulas.sol:70-72](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L70-L72)) multiplied
...
5. **Resource within N hours of cap -> spend it, or build storage.** Computes
   ...
   - If the building queue is **busy**, this rung proposes nothing at all and falls
     ...
     [VeydriftGame.sol:147-168](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/VeydriftGame.sol#L147-L168)) — a second `startBuildingUpgrade` while one is already
