...
[`packages/contracts/src/libraries/VeydriftFormulas.sol`](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol),
[VeydriftAntiRaidPrimitives.sol](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftAntiRaidPrimitives.sol), [VeydriftFleetFuel.sol](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFleetFuel.sol), [VeydriftCatalog.sol](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftCatalog.sol) and
[VeydriftGameplayModule.sol](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/VeydriftGameplayModule.sol) directly at commit `202d1acd9e35d815bd66cb9bae744341b1b1cf9e`
...
cost-scaling function**. `buildingCostFactor` ([VeydriftCatalog.sol:34-45](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftCatalog.sol#L34-L45)) returns an
...
Source: [VeydriftFormulas.sol:221-223](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L221-L223) (`_scaledLevelValue`), which is
...
denominator)` ([VeydriftFormulas.sol:174-181](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L174-L181), `scaleByFactor`) is the general form; every
...
Source: [VeydriftFormulas.sol:225-229](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L225-L229) (`_scaledLevelValueCeil`). `fusion_energy` (§3)
...
Source: [VeydriftFormulas.sol:25-35](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L25-L35) (`planetMultipliers`). **Metal and crystal
...
Source: [VeydriftFormulas.sol:143-149](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L143-L149) (`solarSatelliteEnergy`). **Uses truncating
...
Source: [VeydriftFormulas.sol:107-129](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L107-L129) (`energyBalance`). Note the contract's own
...
Source: [VeydriftFormulas.sol:131-137](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L131-L137) (`fusionReactorEnergyProduction`) —
...
Source: [VeydriftFormulas.sol:139-141](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L139-L141) (`fusionReactorDeuteriumConsumption`), via the
...
Source: [VeydriftFormulas.sol:93-105](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L93-L105) (`crawlerProductionBoostBps`). 0.02% per effective
...
Source: [VeydriftFormulas.sol:37-91](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L37-L91) (`productionPerHour`). **The order matters and must
...
[VeydriftGameStorage.sol](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/VeydriftGameStorage.sol)) and floor at `min_queue_seconds` (contract default 1,
`MIN_QUEUE_SECONDS`).
...
Sources: [VeydriftFormulas.sol:160-172](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L160-L172) (`buildingDuration`), `:199-211`
...
Source: [VeydriftFormulas.sol:241-295](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFormulas.sol#L241-L295) (`_storageCap`), used identically for Metal
...
Source: [VeydriftGameplayModule.sol:844-859](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/VeydriftGameplayModule.sol#L844-L859) (`_planetDistance` / `_absoluteDifference`).
...
[VeydriftGameStorage.sol:54](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/VeydriftGameStorage.sol#L54)) — not a function of two coordinates, so not reproduced in
`distance()`.
...
Source: [VeydriftAntiRaidPrimitives.sol:55-68](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftAntiRaidPrimitives.sol#L55-L68) (`travelSeconds`, 4-arg overload).
...
bit-shift Babylonian-method `_sqrt` ([VeydriftAntiRaidPrimitives.sol:240-278](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftAntiRaidPrimitives.sol#L240-L278)) for every
non-negative input.
...
Sources: [VeydriftAntiRaidPrimitives.sol:93-131](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftAntiRaidPrimitives.sol#L93-L131) (`ogameFuelNumerator` /
`ogameFuelDenominator` / `ogameFuelCostFromNumerator`), aggregated across ship types
exactly as [VeydriftFleetFuel.sol:9-34](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftFleetFuel.sol#L9-L34) (`ogameMissionFuelCost`) does: sum each flyable
...
(Costs computed from [VeydriftCatalog.sol](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/libraries/VeydriftCatalog.sol)'s published base cost (75, 30, 0) and factor
...
Source: [VeydriftGame.sol:693-694](https://github.com/Borodutch/veydrift/blob/202d1acd9e35d815bd66cb9bae744341b1b1cf9e/packages/contracts/src/VeydriftGame.sol#L693-L694) (`maxPlanets`). `docs.md` only says Astrophysics
